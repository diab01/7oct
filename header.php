		...
		<div class="row inner">
			...
			<div class="col-md-5 right">
				<ul>
					...
					<li><a href="cart.php"><i class="fa fa-shopping-cart"></i> <?php echo LANG_VALUE_18; ?> (<?php echo "L.L"; ?><?php
			...
			<div class="col-md-3 search-area">
				...
				<form class="navbar-form navbar-left form" role="search" action="search-result.php" method="get">
    <?php $csrf->echoInputField(); ?>
    <div class="form-group">
        <label for="search_text" class="label">
            <input required="" autocomplete="off" placeholder="<?php echo LANG_VALUE_2; ?>" id="search_text" type="text" class="form-control search-top">
            <div class="icon">
