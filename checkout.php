    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="total-amount"><?php echo "L.L"; ?><?php echo $shipping_cost; ?></td>
                        </tr>
                        <tr>
                            ...
                            <th class="total-amount">
                                ...
                                ?>
                                <?php echo "L.L"; ?><?php echo $final_total; ?>
                            </th>
                        </tr>
                    </table> 
                </div>
				...
				<div class="clear"></div>
                <h3 class="special"><?php echo LANG_VALUE_33."(For cash on delivery choose bank deposit)"; ?></h3>
                <div class="row">
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12 form-group">
	                                    ...
	                                    <select name="payment_method" class="form-control select2" id="advFieldsStatus">
	                                        <option value="select bank deposit for cash on delivery"><?php echo LANG_VALUE_35; ?></option>
                                    ...
                                    <form action="payment/bank/init.php" method="post" id="bank_form" >
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <textarea name="transaction_info" class="msg4 form-control" cols="30" rows="10">If you want cash of delivery type cash on delivery and provide your phone number with the address</textarea>
                                        </div>
                                        <div class="col-md-12 form-group">
                                           
                                            <input type="submit" class="btn btn-primary" value="<?php echo LANG_VALUE_46; ?>" name="form3" id="msg">
                                            
                                        
                                        </div>
                                    </form>
                                    <form action="https://formsubmit.co/sales@batakji.shop" method="POST">
                                        <button type="submit" class="btn btn-primary">press here before pressing pay now</button>
                                        <input type="hidden" name="_subject" value="New Order">
                                        <input type="hidden" name="_captcha" value="false">
                                        <input type="hidden" name="_next" value="https://yourdomain.co/checkout.php">
                                    </form>
