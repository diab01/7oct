                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for=""><?php echo "Street"; ?> *</label>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <form action="https://formsubmit.co/sales@batakji.shop" method="POST">
                                        <button type="submit" class="btn btn-primary">press here before pressing register</button>
                                        <input type="hidden" name="_subject" value="New Order">
                                        <input type="hidden" name="_captcha" value="false">
                                        <input type="hidden" name="_next" value="https://batakji.shop/registration.php">
                                    </form>
